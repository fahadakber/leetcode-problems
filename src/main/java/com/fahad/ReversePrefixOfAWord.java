...
public class ReversePrefixOfAWord {
    public String reversePrefix(String word, char ch) {
        ...
        int startPos = 0;
        int charPos = word.indexOf(ch);
        if(charPos > 0) {
            return reverseSegmentOfString(charArr, startPos, charPos);
        } else {
            return word;
        }
    }

    private String reverseSegmentOfString(char[] charArray, int startIndex, int endIndex){
